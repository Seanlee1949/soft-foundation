...
(
    ...
    PILE_DESCRIBE VARCHAR
(
    64
)
    );
create
INDEX idx_device_key ON SF_HISTORY_DETAIL_DATA(DEVICE_KEY);
create
INDEX idx_pile_describe ON SF_HISTORY_DETAIL_DATA(PILE_DESCRIBE);
ALTER TABLE SF_HISTORY_DETAIL_DATA
    ADD PILE_KEY VARCHAR(255);
create
INDEX idx_pile_key ON SF_HISTORY_DETAIL_DATA(PILE_KEY);
...
ALTER TABLE SF_RECORD ALTER COLUMN CONTENT varchar(500)